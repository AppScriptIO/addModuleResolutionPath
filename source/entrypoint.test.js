...
import { addModuleResolutionPath, addModuleResolutionPathMultiple } from './entrypoint.js'
const testAssetPath = path.join(configuration.directory.application.containerAbsolutePath, 'test/asset')
const moduleFolder = [
    path.join(testAssetPath, 'moduleFolder1'),
    path.join(testAssetPath, 'moduleFolder2'),
]
